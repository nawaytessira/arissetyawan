...
for neuron in neurons
	...
	for fold in range(total_fold):
		...
		elmr = ELMRandom(["sigmoid", 1, neuron, True])

		elmo = ELMRandom(["sigmoid", 1, neuron, True, random_orthogonal(data, neurons)])
		elmrbm = ELMRandom(["sigmoid", 1, neuron, True, rbm(data, 100)])
