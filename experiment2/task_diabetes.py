...
# load dataset
data= np.loadtxt(DIR + "diabetic.ssv.label_first.min_max")
...
for i in range(trial):
	...
	for fold in range(total_fold):
		...
		# use % training % testong and shuffle data before splitting
		...
		tr_rmse_ortho= tr_result.get_rmse()
		#te_result = elmr.test(te_set)
		#print(te_result.get_accuracy())
		end = time.time()
		acc_ortho.append(tr_acc_ortho)
		rmse_ortho.append(tr_rmse_ortho)
		...
		tr_rmse_rbm= tr_result.get_rmse()
		#te_result = elmr.test(te_set)
		#print(te_result.get_accuracy())
		end = time.time()
		acc_rbm.append(tr_acc_rbm)
		rmse_rbm.append(tr_rmse_rbm)
		...
		print("RMSE: ")
		print("ELM Random: ", tr_rmse_rand)
		print("ELM Orthogonal: ", tr_rmse_ortho)
		print("ELM RBM: ", tr_rmse_rbm)
...
print ('RMSE -  mean: ', rmse_rand.mean(), '| Std: ', rmse_rand.std())
...
print ('RMSE -  mean: ', rmse_ortho.mean(), '| Std: ', rmse_ortho.std())
print ('Time - mean: ', tim_rand.mean(), ' | Std: ', tim_rand.std())
...
print ('RMSE -  mean: ', rmse_rbm.mean(), '| Std: ', rmse_rbm.std())
