...
for t in range(trials):
    ...
    for j in range(kfold-1):
        ...
        mydata.save("datasets/australian")
        mydata.load()
        ###########################################################################
        print(line2())
        ...
        # k = 35, it = 25, η = 0.1, ρ = 0.1, α = 0.5/0.9 and bs = 150
        rbmNet.train (maxIter=maxIterRbm, lr=0.1, wc=0.1, iMom=0.5, fMom=0.9, cdIter=1, batchSize=150, freqPrint=10)
        ...
        elmNet1.saveELM("log/australian-rbm_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet1)
        ...
        elmNet2.saveELM("log/australian-rnd_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet2)
        ...
        elmNet3.saveELM("log/australian-ro_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet3)
