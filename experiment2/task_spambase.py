...
# mydataset= pd.read_csv(DATA_PATH+ 'spambase.csv', header=0, dtype=None)
# mydataset= mydataset.reset_index().values
...
for t in range(trials):
    ...
    for j in range(kfold-1):
        ...
        elmNet1.saveELM("log/spambase-rbm_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet1)
        ...
        elmNet2.saveELM("log/spambase-rnd_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet2)
        ...
        elmNet3.saveELM("log/spambase-ro_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet3)
