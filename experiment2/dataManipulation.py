...
class data:
    ...
    # train, val and test. 
    def __init__(self, dataset=None, train=None, val=None, test=None, percTrain=0.7, percVal=0.1, percTest=0.2, normType=None, shuf=True, posOut='last', outBin=False):
    ...
    def binOut (self):
        p("Found binary class as output")
        if self.trainOut is not None:
