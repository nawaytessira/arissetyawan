...
MAIN_DIR= '/media/arissetyawan/01D01F7DA71A34F0/__PASCA__/__THESIS___/experiment2/'
...
class RBM_TF:
   ...
   # The constructor method
    def settings():
        return ("numHid: " + this.numHid  + ", weights: " + this.weights + ", visBias: " + this.visBias + ", rbm type: " + this.rbmType)
