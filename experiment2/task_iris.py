...
mydataset = np.genfromtxt(DATA_PATH+ 'iris.csv', skip_header=0, delimiter=',')
...
for t in range(trials):
    ...
    for j in range(kfold-1):
        ...
        elmNet1.saveELM("log/iris-rbm_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet1)
        ...
        elmNet2.saveELM("log/iris-rnd_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet2)
        ...
        elmNet3.saveELM("log/iris-ro_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet3)
