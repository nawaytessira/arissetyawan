...
mydataset = np.genfromtxt(DATA_PATH+ 'madelon.csv', delimiter=',')
...
for t in range(trials):
    ...
    for j in range(kfold-1):
        ...
        elmNet1.saveELM("log/madelon-rbm_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet1)
        ...
        elmNet2.saveELM("log/madelon-rnd_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet2)
        ...
        elmNet3.saveELM("log/madelon-ro_" + str(trial) + "-" + str(percTrain) + "-" + str(percTest) + "_" + str(i))
        del(elmNet3)
